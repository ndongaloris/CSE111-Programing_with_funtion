...
def sum_protons(symbol_quantity_list, periodic_table_dict):
    ...
    for elements in symbol_quantity_list:
        ...
        atomic_num = dict_value[ATOMIC_NUM_INDEX]
        protons = atomic_num * quantity
...
def get_formula_name(formula, known_molecules_dict):
    ...
    if formula in known_molecules_dict:
        known_molecules = known_molecules_dict[formula]
    else:
        known_molecules = "Unknown."
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for elements in symbol_quantity_list:
        ...
        total_molar_mass += mass_quantity 
...
def make_periodic_table():
    periodic_table_dict = {
        # [symbol, name, atomic_mass, atomic_num]
        "Ac": ["Actinium",	227, 89],               
...
def main():
    """Get the for the chemical formula and the mass of 
    a chemical sample in grams from the user
    """
    formula = input("Enter the chemical formula for a molecule: ").upper()
    
    formula_name = get_formula_name(formula, known_molecules_dict)
    
    # Get the mass of a chemical sample in grams from the user
    mass = float(input("Enter the mass chemical sample in grams: "))
    ...
    #call the sum_protons and 
    #store the total number of protons into the T_protons. 
    T_protons = sum_protons(symbol_quantity_list, periodic_table_dict)
    ...
    print("Total number of protons:",T_protons)

    # Print the formula name
    print("The formula name:",formula_name)
    
    # Print the molar mass.
    print(F"The molar mass: {molar_mass} grams/mole")
    
    # Print the number of moles.
    print(f"The number of moles: {number_of_moles:.5f} moles")
