...
def make_sentence(quantity, tense):
    """Build and return a sentence with ten words:
    two determiners, two nouns, two adjectives, two prepositional phrases and a verb. The grammatical
    quantity of the two determiners, nouns, prepositional phrases will match the
    ...
    sentence = f"{determiner} {adjective} {noun} {prepositional_phrase} {adverb} {verb} "\
               f"{determiner_2} {adjective_2} {noun_2} {prepositional_phrase_2}.".capitalize()
    return sentence
